...
const IndividualJobs = ({ job}) => {
    const {id, remote_or_onsite, company_logo, job_title, company_name, job_type, location, salary } = job
    ...
    return (
        <div>
            <div>
                ...
                <h1 className="text-gray-500 font-semibold text-lg">{job_type} {remote_or_onsite}</h1>
