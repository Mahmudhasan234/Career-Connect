...
const Appliedjob = ({ appliedjob }) => {
    ...
    const { id, remote_or_onsite, company_logo, job_title, company_name, job_type, location, salary } = appliedjob;
    return (
            ...
            <div className='flex items-center'>
                ...
                <div className='flex items-center flex-grow justify-between p-5'>
                    <div>
                        ...
                        <h1 className='text-lg text-orange-400' >{job_type} {remote_or_onsite}</h1>
