    ...
    return (
        <div className='container mx-auto lg:px-28 my-2 lg:my-5'>
            <div className='flex justify-between items-center'>
                <div className='px-36'>
                    <h1 className='text-6xl font-bold pr-52'>One Step Closer To Your <span className='text-purple-400'>Dream Job</span></h1>
                    ...
                    <button className=' mt-7 border-0 btn bg-gradient-to-r from-indigo-500 to-purple-500'>Get Started</button>
                </div>
                <div>
